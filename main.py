...
#link field
link_field = Entry(screen, width=40, font=('Times New Roman', 15) )
link_label = Label(screen, text="Enter Download Link: ", font=('Times New Roman', 30, "bold"))

#Select Path for saving the file
path_label = Label(screen, text="Select Path For Download", font=('Times New Roman', 25, "bold"))
